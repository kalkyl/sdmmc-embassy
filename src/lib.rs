...
pub use crate::blockdevice::{Block, BlockCount, BlockIdx};
...
pub struct Controller<T, SPI, CS>
where
    T: TimeSource,
...
impl<T, SPI, CS> Controller<T, SPI, CS>
where
    T: TimeSource,
    SPI: 'static + embassy_traits::spi::FullDuplex<u8> + embassy_traits::spi::Spi<u8>,
    CS: 'static + embedded_hal::digital::v2::OutputPin,
    <SPI as embassy_traits::spi::Spi<u8>>::Error: core::fmt::Debug,
{
    ...
    /// files.
    pub fn new(block_device: SdMmcSpi<SPI, CS>, timesource: T) -> Controller<T, SPI, CS>
    where
        SPI: 'static + embassy_traits::spi::FullDuplex<u8> + embassy_traits::spi::Spi<u8>,
        CS: 'static + embedded_hal::digital::v2::OutputPin,
        <SPI as embassy_traits::spi::Spi<u8>>::Error: core::fmt::Debug,
    ...
    pub fn device(&mut self) -> &mut SdMmcSpi<SPI, CS>
    where
        SPI: 'static + embassy_traits::spi::FullDuplex<u8> + embassy_traits::spi::Spi<u8>,
        CS: 'static + embedded_hal::digital::v2::OutputPin,
        <SPI as embassy_traits::spi::Spi<u8>>::Error: core::fmt::Debug,
    ...
    /// being unlinked.
    pub fn open_root_dir(&mut self, volume: &Volume) -> Result<Directory, Error<sdmmc::Error>> {
    ...
    fn get_open_files_row<E: core::fmt::Debug>(&self) -> Result<usize, Error<E>> {
    ...
    pub async fn read<D: embassy_traits::delay::Delay>(
        ...
        file: &mut File,
        buffer: &mut [u8],
    ) -> Result<usize, Error<sdmmc::Error>> {
    ...
    pub fn close_file<E: core::fmt::Debug>(
        &mut self,
        volume: &Volume,
        file: File,
    ) -> Result<(), Error<E>> {
    ...
    pub fn free(self) -> (SdMmcSpi<SPI, CS>, T) {
